...
const RULES_COMMON = [
  ...
  "Player ID Code ভুল দিয়ে Diamond না পেলে Uc Ghor কর্তৃপক্ষ দায়ী নয়।",
...
async function main() {
  ...
  await prisma.notice.create({
    data: {
      message:
        "Uc Ghor এ ২৪ ঘন্টাই টপআপ চালু থাকে....!!! যেকোনো সমস্যায় আমাদের WhatsApp এ মেসেজ দিন 01343053411 ......... বিঃদ্রঃ মা-বাবা বা ফ্যামিলির কারো ফোন থেকে টাকা চুরি করে টপআপ করলে তার বিরুদ্ধে আইনগত ব্যাবস্থা নেয়া হবে",
      isActive: true,
    },
  });
  ...
  const adminEmail = process.env.SEED_ADMIN_EMAIL || "admin@ucghor.com";
