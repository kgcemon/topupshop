...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <div className="container mx-auto mb-8 flex flex-wrap items-center justify-center gap-4 px-3 md:px-4">
        <a
          href="#"
          className="flex items-center gap-3 rounded-xl border-2 border-gray-300 bg-white px-4 py-2 transition-shadow hover:shadow-md"
        >
          <Image src="/images/app_link.png" alt="Google Play" width={32} height={32} className="h-8 w-8 object-contain" />
